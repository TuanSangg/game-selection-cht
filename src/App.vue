...
const items = [
  ...
  { img: '/img/lit.PNG', link: 'https://wordle-vi.thptchuyenhatinh.edu.vn/', name: 'Literature', color: '#f0ce8a' },
  ...
  { img: '/img/english.png', link: 'mikhad.github.io/wordle', name: 'English', color: '#e0b990' },
